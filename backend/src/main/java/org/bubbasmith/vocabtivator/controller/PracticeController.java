...
import org.bubbasmith.vocabtivator.practice.SentencePracticeService;
...
public class PracticeController {
    ...
    public SentenceWithHintDTO get(@RequestParam String tableKey, @RequestParam String topics) {
        return sentencePracticeService.findSentenceByRandomWord(tableKey, topics.isEmpty() ? Collections.emptyList() : Arrays.asList(topics.split(",")));
    }
}
